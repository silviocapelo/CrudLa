...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'text_message'          => 'texto',
        'summary_message'       => 'resumo',
        'content_id'            => 'conteúdo',
        'levels.1.level_title'  => 'nível 1',
        'levels.2.level_title'  => 'nível 2',
        'levels.3.level_title'  => 'nível 3',
        'levels.4.level_title'  => 'nível 4',
        'category_id'           => 'categoria',
        'icon'                  => 'ícone',
        'type'                  => 'tipo',
        'cel_authorization'     => 'acesso ao celular',
        '0'                      => 'nome',
        '1'                      => 'email',
        '2'                      => 'cpf',
        '3'                      => 'código funcional',
        'enunciate.*.*'          => 'questão',
        'category_tips_id'       => 'categoria',
        '*.functional_code'      => 'código funcional',
        '*.name'                 => 'nome',
    ],
];
